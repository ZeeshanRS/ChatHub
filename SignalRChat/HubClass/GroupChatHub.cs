...
namespace SignalRChat.HubClass
{
       ...
       /// </summary>
        ...
        public void LoadChatHistory()
        {
            ...
            if (id>0)
            {
                ...
                if (history.Count>0)
                {
                    Clients.Group("GROUP-Admin").publishChatHistory(history, UserName);
                }
            }
        ...
        public void EmailChat()
        {
            ...
            if (id > 0)
            {
                UserChat.EmailChatHistory(UserName);
            }                        
        }
        /// <summary>
        /// Format message 
    ...
    public class GroupChat
    {
        ...
        {
            Clients.Group("GROUP-Admin").publishSystemMsg(new { Name = "Everyone", Msg = msg, Time = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") });
        }
    }
}